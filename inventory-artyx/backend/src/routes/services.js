...
router.post('/', async (req, res, next) => {
  try {
    ...
    const hourlyRate = base_price ? Number(base_price) : null;
    const stdHours = standard_hours ? Number(standard_hours) : 1.0;
    const durationMinutes = default_duration_minutes ? Number(default_duration_minutes) : Math.round(stdHours * 60);
    ...
    const sql = `
      INSERT INTO services (
        ...
        default_duration_minutes,
        internal_cost_per_hour, internal_notes, standard_hours
      ) VALUES (
